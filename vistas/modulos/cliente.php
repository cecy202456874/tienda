            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cecy</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            ...
                            <?php
                            $parametro= null;
                            $datosClientes = ControladorClientes::crtlCargarCliente($parametro, 0);
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         <button class='btn btn-warnig btnCargarDatos' idClientes='". $valor['id_cliente']."' data-toggle='modal' data-target='#modificar'><i class='fas fa-edit'></i></button>
                ...
                <div id="modificar" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Cédula de identidad" name="modificae_cedula" id="modificae_cedula" required>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    </div>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Direccion" name="modificarmodificar_direccion" id="modificarmodificar_direccion" required>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-route"></i></span>
                                    </div>
